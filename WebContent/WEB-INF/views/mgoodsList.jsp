...
<div id="pagewrap">
		...
		<div id="content">
			...
			<br/><br/>
				...
				<c:if test="${!empty requestScope.goodss }">
					<div style="text-align: center;">该订单中物品</div>
					<c:forEach items="${requestScope.goodss }" var="goods" >
						<div class="row">
						   		<div class="col-sm-4" > 
								  <div class="ct-product"> 
									<div class="image ct-product-button"><img src="${pageContext.request.contextPath }/${goods.image }" alt=""></div>
									<div class="inner">
									  	<h2 class="ct-product-title" id="ct-product-title">${goods.name }</h2>
